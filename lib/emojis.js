var url = require('url')
var emojis = require('../asset/emojis')

exports.replaceWithUnicode = function (input, snippet) {
  if( snippet ) emojijs = snippet;
  return replace(input, unicodeForEmoji)
}

exports.replaceWithHtml = function (input, baseUrl, snippet) {
  if( snippet ) emojijs = snippet;
